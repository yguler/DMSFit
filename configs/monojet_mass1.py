...
out_file_name = 'monojet-mass1.root'
...
monojet_doublebp_mass1_category = {
	    'name':"monojet_mass1"
...
monojet_doublebf_mass1_category = {
	    'name':"monojet_mass1_fail"
            ,'in_file_name':"/uscms_data/d1/shoh/panda/v_8029_DarkHiggs_v2/flat/limits/fittingForest_all.root"
            ,"cutstring":"n2ddt56<0 && fjmass>75 && fjmass<100"
            ,"varstring":["min(999.9999,met)",250,1400]
       	    ,"weightname":"weight"
...
categories = [monojet_doublebp_mass1_category,monojet_doublebf_mass1_category]
