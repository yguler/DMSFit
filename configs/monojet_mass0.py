...
out_file_name = 'monojet-mass0.root'
...
monojet_doublebp_mass0_category = {
	    'name':"monojet_mass0"
...
monojet_doublebf_mass0_category = {
	    'name':"monojet_mass0_fail"
            ,'in_file_name':"/uscms_data/d1/shoh/panda/v_8029_DarkHiggs_v2/flat/limits/fittingForest_all.root"
            #,"cutstring":"n2ddt56<0 && fjmass>50 && fjmass<75"
            ,"cutstring":"n2ddt56<0 && fjmass>25 && fjmass<75"
            ,"varstring":["min(999.9999,met)",250,1400]
...
categories = [monojet_doublebp_mass0_category,monojet_doublebf_mass0_category]
