...
out_file_name = 'monojet-mass3.root'
...
monojet_doublebp_mass3_category = {
	    'name':"monojet_mass3"
...
monojet_doublebf_mass3_category = {
	    'name':"monojet_mass3_fail"
            ,'in_file_name':"/uscms_data/d1/shoh/panda/v_8029_DarkHiggs_v2/flat/limits/fittingForest_all.root"
            ,"cutstring":"n2ddt56<0 && fjmass>150 && fjmass<3000"
            ,"varstring":["min(999.9999,met)",250,1400]
       	    ,"weightname":"weight"
...
categories = [monojet_doublebp_mass3_category,monojet_doublebf_mass3_category]
