...
for i in range(fpf_s.getSize()):
    ...
    #if name == "zjetseff" or name == "wjetseff" or name == "ttbareff":
    #  continue
    name = name.replace("monohiggs_","")
...
if options.plotfile:
    ...
    canvas_nuis.SaveAs(plotsDir+"pulls_data.pdf") 
    canvas_nuis.SaveAs(plotsDir+"pulls_data.png") 
    canvas_nuis.SaveAs(plotsDir+"pulls_data.C") 
    #canvas_nuis.SaveAs(plotsDir+"pulls_manual_fix.pdf") 
    #canvas_nuis.SaveAs(plotsDir+"pulls_manual_fix.png") 
    #canvas_nuis.SaveAs(plotsDir+"pulls_manual_fix.C") 
    #canvas_nuis.SaveAs(plotsDir+"pulls_data_maskedsignal.pdf") 
    #canvas_nuis.SaveAs(plotsDir+"pulls_data_maskedsignal.png") 
    #canvas_nuis.SaveAs(plotsDir+"pulls_data_maskedsignal.C") 
    
    canvas_pferrs = ROOT.TCanvas("post_fit_errs", "post_fit_errs", 900, 600)
    for b in range(1,hist_fit_e_s.GetNbinsX()+1): 
      if hist_prefit.GetBinError(b)!=0:
        ...
        hist_fit_e_s.SetBinContent(b,-99)
        hist_fit_e_b.SetBinContent(b,-99)
