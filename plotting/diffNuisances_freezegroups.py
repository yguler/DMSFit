...
if options.plotfile:
    ...
    canvas_nuis.SaveAs(plotsDir+"pulls_data_freezeallstat.pdf") 
    canvas_nuis.SaveAs(plotsDir+"pulls_data_freezeallstat.png") 
    canvas_nuis.SaveAs(plotsDir+"pulls_data_freezeallstat.C") 
